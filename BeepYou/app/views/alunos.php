...
$objAluno = new Alunos();
$alunos = $objAluno->ListarTodosAlunos();
                    ...
                    <section class="table-box">
                        <div class="table-header">
                            <h2 class="titulo-pagina">
                                <img src="../../public/img/1aluno.png" class="titulo-icone" alt="Alunos"> Alunos</h2>
                            <a href="cadastroAluno.php" class="btn-adicionar"> + Adicionar aluno</a>
                        </div>
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="../controllers/visualizarAluno.php?id=<?php echo $aluno['id_alunos']; ?>"
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox"
                                                <?php echo (($aluno["ativo"] ?? true)
                                                    ? "checked"
                                                    : ""); ?>
                                                onclick="return confirmarInativacaoAluno(
                                                    this,
                                                    <?php echo $aluno['id_alunos']; ?>,
                                                    <?php echo $aluno['possui_emprestimo']
                                                        ? 'true'
                                                        : 'false'; ?>
                                                )"
                                            >
