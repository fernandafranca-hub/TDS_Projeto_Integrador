...
<head>
    ...
    <title>BeepYou - CADASTRO ALUNOS</title>
                    ...
                    <section class="table-box">
                        <div class="table-header">
                            <div class="titulo-area">
                                <h2 class="titulo-pagina"><img src="../../public/img/1aluno.png" class="titulo-icone" alt="Aluno"> Cadastrar Aluno</h2>
                                <a href="alunos.php">
                                    <span class="icon-acao icon-voltar" title="Voltar"></span>
                                </a>
                            </div>
                        </div>
                       <form action="../controllers/salvarAluno.php" method="POST" class="form-cadastro">
                            <label for="matricula"> Matrícula </label>
                            <input type="text" name="matricula" id="matricula" class="campo-form" placeholder="Digite a matrícula" required>
                            <label for="nome"> Nome </label>
                            <input type="text" name="nome" id="nome" class="campo-form" placeholder="Nome do aluno" required>
                            <label for="email"> E-mail </label>
                            <input type="email" name="email" id="email" class="campo-form" placeholder="E-mail do aluno" required>
                            <label for="telefone"> Telefone </label>
                            <input type="text" name="telefone" id="telefone" class="campo-form" placeholder="Telefone do aluno" required>                            
                            <label for="curso"> Curso </label>                            
                            <input type="text" name="curso" id="curso"s class="campo-form" placeholder="Curso" required>
