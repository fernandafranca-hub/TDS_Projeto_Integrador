...
<head>
    ...
    <title>BeepYou - CADASTRO PATRIMÔNIO</title>
                        ...
                        <section class="table-box">
                            <div class="table-header">
                                <div class="titulo-area">
                                    <h2 class="titulo-pagina"><img src="../../public/img/1patrimonio.png" class="titulo-icone" alt="Patrimônio"> Cadastrar Patrimônio</h2>
                                   <a href="patrimonio.php">
                                        <span class="icon-acao icon-voltar" title="Voltar"></span>
                                    </a>
                                </div>
                            </div>
                            <form action="../controllers/salvarPatrimonio.php"method="POST"class="form-cadastro">
                                <label for="codigo">Código</label>
                                <input type="text" name="codigo" id="codigo" class="campo-form" placeholder="Digite o código" required>
                                <label for="nome"> Nome do Patrimônio </label>
                                <input type="text" name="nome" id="nome" class="campo-form" placeholder="Digite o nome do patrimônio"required>
                                <label for="categoria">Categoria</label>
                                <input type="text" name="categoria" id="categoria" class="campo-form" placeholder="Ex: Informática, Livro, Equipamento" required>
                                <label for="descricao">Descrição</label>
                                <input type="text" name="descricao" id="descricao" class="campo-form" placeholder="Digite uma descrição do patrimônio" required>
                                <label for="status">Status</label>
                                <select name="status" id="status" for="status" class="campo-form">
