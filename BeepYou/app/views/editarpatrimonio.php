...
<head>
    ...
    <title>BeepYou - EDITAR PATRIMÔNIO</title>
                ...
                <main class="conteudo-pagina">
                    ...
                    <div class="area-busca">
                        ...
                        <section class="table-box">
                            ...
                            <form action="../controllers/editarPatrimonio.php" method="POST" class="form-cadastro">
                                <input type="hidden" name="id_patrimonio" value="<?php echo $patrimonio['id_patrimonio']; ?>">
                                <label for="codigo"> Código </label> 
                                <input type="text" id="codigo" name="codigo" class="campo-form" value="<?php echo $patrimonio['codigo']; ?>" required>
                                <label for="nome">Nome</label>
                                <input type="text" id="nome" name="nome" class="campo-form" value="<?php echo $patrimonio['nome']; ?>" required>
                                <label for="categoria"> Categoria </label>
                                <input type="text" id="categoria" name="categoria" class="campo-form" value="<?php echo $patrimonio['categoria']; ?>" required>
                                <label for="descricao"> Descrição </label> 
                                <input type="text" id="descricao" name="descricao" class="campo-form" value="<?php echo $patrimonio['descricao']; ?>" required>                               
                                <label for="status" onclick="document.getElementById('status').click();">Status</label>
                                <select name="status" id="status" class="campo-form">
                                    <option value="Disponível" <?php if($patrimonio['status']=="Disponível") echo "selected"; ?>>Disponível</option>
                                    <option value="Indisponível" <?php if($patrimonio['status']=="Indisponível") echo "selected"; ?>>Indisponível</option>
                                    <option value="Manutenção" <?php if($patrimonio['status']=="Manutenção") echo "selected"; ?>>Manutenção</option>
                                </select>
